...
import { SearchInsightsBar } from "@/app/(admin)/dashboard/header/SearchInsightsBar";
...
const isAuthPage =
  ...
  return (
    <header className="sticky top-0 flex w-full bg-white border-gray-200 z-50 dark:border-gray-800 dark:bg-gray-900 lg:border-b">
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:pr-10 lg:pl-35">
